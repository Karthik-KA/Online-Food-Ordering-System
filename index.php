        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" id="yummy-brand" href="index.php">Yummy.</a>
        ...
        <section class="hero bg-image" data-image-src="images/img/restrrr.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Yummy.</h1>
                    <h5 class="font-white space-xs">Choose it & Enjoy your meals!</h5>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Yummy - The Best Food Delivery App</h3>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> Yummy. </a> <br> <span>Choose it &amp; Enjoy your meals! </span> </div>
